...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-black/5 bg-cream/95 backdrop-blur-sm">
      <div className="mx-auto grid h-16 max-w-7xl grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-x-2 px-3 sm:h-[4.5rem] sm:gap-x-6 sm:px-6 md:px-10">
        <nav
        ...
        <Link
          href="/"
          className="justify-self-center whitespace-nowrap px-0.5 font-serif text-2xl font-medium italic leading-none tracking-tight text-charcoal sm:px-2 sm:text-3xl md:text-4xl"
        >
